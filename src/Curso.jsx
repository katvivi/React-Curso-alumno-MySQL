...
export class Curso extends Component {
  ...
  cambiardescripcion = (e)=> {
    this.setState({ DescripcionCurso: e.target.value });
  }

  cambiarduracion = (e) => {
    this.setState({ DuracionCurso: e.target.value });
  }

  cambiarFechaInicio = (e) => {
    this.setState({ FechaInicioCurso: e.target.value });
  }

  cambiarFechaFin = (e) => {
    this.setState({ FechaFinCurso: e.target.value });
  }

  addClick() {
    this.setState({
      tituloModal: "Agregar Curso",
      IdCurso: 0,
      NombreCurso: "",
      DescripcionCurso: "",
      DuracionCurso: "",
  ...
  editClick(cur) {
    this.setState({
      tituloModal: "Editar Curso",
      IdCurso: cur.Id,
      NombreCurso: cur.Nombre,
      DescripcionCurso: cur.Descripcion,
      DuracionCurso: cur.Duracion,
      FechaInicioCurso: cur.FechaInicio,
      FechaFinCurso: cur.FechaFin,
    });
  }
